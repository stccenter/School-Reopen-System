...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $param_email = trim($_POST["inputEmail"]);
        ...
        $sql = "INSERT INTO feedback (appname, gname, email, comment) VALUES (?, ?, ?, ?)";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand">Spatiotemporal Campus/School Reopen Decision Support System Feedback</a>
